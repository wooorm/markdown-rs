...
> Make sure to use the new crate, currently in alpha at `1.0.0-alpha.20`.
...
`markdown-rs` exposes
[`to_html`](https://docs.rs/markdown/1.0.0-alpha.20/markdown/fn.to_html.html),
[`to_html_with_options`](https://docs.rs/markdown/1.0.0-alpha.20/markdown/fn.to_html_with_options.html),
[`to_mdast`](https://docs.rs/markdown/1.0.0-alpha.20/markdown/fn.to_mdast.html),
[`Options`](https://docs.rs/markdown/1.0.0-alpha.20/markdown/struct.Options.html),
...
[docs]: https://docs.rs/markdown/1.0.0-alpha.20/markdown/

[crate-badge]: https://img.shields.io/crates/v/markdown

[crate]: https://crates.io/crates/markdown/1.0.0-alpha.20
